...
def create_card_attachment(card_type, title, subtitle, text, images, buttons):
    """
    card type : adaptive , hero, list , receipt , signin ,thumbnail , card collections,o365connector
    """
...
def send_card(token, bot_id, bot_name, recipient, reply_to_id, service, 
                sender, message_type, card_attachment, text):
    try:
        payload = {
                    "from": {
                        "id": bot_id,
